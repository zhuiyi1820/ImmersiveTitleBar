...
import com.lhj.imm.view.StickyScrollView;
 ...
 * 描述：仿淘宝渐变+悬浮+吸顶效果
 */
public class TitleBarImmersiveActivity2 extends AppCompatActivity implements StickyScrollView.OnScrollChangedListener {
    private final static String TAG = "TitleBarImmersiveActivity2";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                height = ll_content.getHeight() - scrollView.getHeight();
                //悬浮高度=base_rl.getHeight()+StatusBarUtil.getStatusBarHeight(TitleBarImmersiveActivity.this)
                scrollView.setStickTop(base_rl.getHeight() + StatusBarUtil.getStatusBarHeight(TitleBarImmersiveActivity2.this));
                Log.e("a", height + "");
                //注意要移除 removeOnGlobalLayoutListener，否则会调用2次
